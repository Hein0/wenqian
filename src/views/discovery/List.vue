	...
	<div class="bc" style="height: 100%">
		...
		<div class="orange-home bc">
			...
			<div class="orange-content content">
				...
				<!--中间-->
				<van-tabs type="card" style="margin-top: -20px" sticky>
					<van-tab title="精选单品">
...
<script>
	...
	export default {
	    ...
	    methods: {
                            ...
                            for (let p = 0;p < itemData.length;p++) {
                                ...
                                if (itemData[p].itemendprice != undefined) {
                                    rsp.data.data[i].goods.push({
                                        ...
                                        price: '券后价格' + itemData[p].itemendprice,
			...
			// },
			// getTheme() { //获取精选主题数据
            //     this.$axios.get('/api/discovery/themeList').then((rsp) => {
            //         if (rsp.data.code == 1) {
